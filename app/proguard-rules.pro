...
# 实体
-keep class com.kingja.qiang.model.entiy.**{*;}
...
# 自定义View
-dontwarn com.kingja.qiang.view.**
-keep class com.kingja.qiang.view.** { *; }
# popwindowsir
...
-keep interface com.kingja.qiang.adapter.DontObfuscateInterface{public *;}
-keep interface * extends com.kingja.qiang.adapter.DontObfuscateInterface {
<methods>;
<fields>;
}
# eventbus3.0
